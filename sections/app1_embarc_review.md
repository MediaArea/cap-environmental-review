...
| 76 | FADGI Process History | 2080+ (up to 1MB) | Optional | Structured multi-line record encoding the complete digitization chain. This field is inspired by the Broadcast WAVE bext Coding History field and focuses on the documentation of provenance history. |
